...
@Component({
  selector: 'app-emp-create-exchange',
  templateUrl: './emp-create-exchange.component.html',
  styleUrls: ['./emp-create-exchange.component.css']
})
export class EmpCreateExchangeComponent implements OnInit {
  TemplateData : any = [];
  ...
  this.Exchanges.Notes= this.UserRes.notes;
    ...
    addExchange() {
        ...
        let jsonObj = {
            ...
            "officerPhone": this.Exchanges.EscrowPhone.toString()?this.Exchanges.EscrowPhone.toString():",",
