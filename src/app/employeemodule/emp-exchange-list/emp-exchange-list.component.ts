...
@Component({
  selector: 'app-emp-exchange-list',
  templateUrl: './emp-exchange-list.component.html',
  styleUrls: ['./emp-exchange-list.component.css']
})
export class EmpExchangeListComponent implements OnInit {
