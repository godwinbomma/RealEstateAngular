...
@Component({
  selector: 'app-emp-manage-approval',
  templateUrl: './emp-manage-approval.component.html',
  styleUrls: ['./emp-manage-approval.component.css']
})
export class EmpManageApprovalComponent implements OnInit {
