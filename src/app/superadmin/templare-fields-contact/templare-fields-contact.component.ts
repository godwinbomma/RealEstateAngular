...
@Component({
  selector: 'app-templare-fields-contact',
  templateUrl: './templare-fields-contact.component.html',
  styleUrls: ['./templare-fields-contact.component.css']
})
export class TemplareFieldsContactComponent implements OnInit {
