...
@Component({
  selector: 'app-syn-exchange',
  templateUrl: './syn-exchange.component.html',
  styleUrls: ['./syn-exchange.component.css']
})
export class SynExchangeComponent implements OnInit {
  ...
  SettlementAgent: any;
  synergytype: number;
  constructor(private formBuilder: FormBuilder, private exchangeService: ExchangeService,private modalService:NgbModal,
