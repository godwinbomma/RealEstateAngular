...
@Component({
  selector: 'app-syn-manage-agent-exchange',
  templateUrl: './syn-manage-agent-exchange.component.html',
  styleUrls: ['./syn-manage-agent-exchange.component.css']
})
export class SynManageAgentExchangeComponent implements OnInit {
 ...
 getExchangeList() {
     this.ExchangeService._getExchangeslist(this.userID).subscribe((data: any)=> {
